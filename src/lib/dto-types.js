...
export const nameDTOSchema = Type.String({
    ...
    maxLength: 20,
    errorMessage: {
        minLength: 'name debe tener como mínimo 2 caracteres de longitud',
...
export const surnameDTOSchema = Type.String({
    ...
    maxLength: 50,
    errorMessage: {
        minLength: 'surname debe tener como mínimo 4 caracteres de longitud',
...
export const passwordDTOSchema = Type.String({
    ...
    errorMessage: {
        ...
        format: 'El formato de la password no es válido, debe contener una mayúscula, una minúscula y un número',
        minLength: 'password debe tener como mínimo 10 caracteres de longitud',
